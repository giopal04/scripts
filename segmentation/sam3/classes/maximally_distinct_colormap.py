# Source - https://stackoverflow.com/a/33295456
# Posted by Tatarize, modified by community. See post 'Timeline' for change history
# Retrieved 2025-12-11, License - CC BY-SA 4.0

maximally_distinct_colormap = [
        "#0000A6", "#FFFF00", "#1CE6FF", "#FF34FF", "#FF4A46", "#008941", "#006FA6", "#A30059",
        "#FFDBE5", "#7A4900", "#000000", "#63FFAC", "#B79762", "#004D43", "#8FB0FF", "#997D87",
...
def hex_to_rgb_tuple(hex_str, debug=False):
	h = hex_str.lstrip('#')
